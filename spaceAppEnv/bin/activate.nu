...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/L/Programming/dataEng/spaceApp/spaceAppEnv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/L/Programming/dataEng/spaceApp/spaceAppEnv/bin/deactivate.nu'
